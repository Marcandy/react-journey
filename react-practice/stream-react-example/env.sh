...
export DB_PASSWORD=Forces$57
export DB_PORT=3306
export MAPBOX_ACCESS_TOKEN=VALUE
export S3_KEY=VALUE
export S3_SECRET=VALUE
export S3_BUCKET=VALUE
export STREAM_APP_ID=23459
export STREAM_KEY=uw2gqav4gyzu
export STREAM_SECRET=vsggpnfgne8dpfuk4mahhb34dhvxqha8s2yxw8uyj2d7yq852y9kg5m97qqr3uxe
